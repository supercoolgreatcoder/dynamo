...
IMAGE_PLACEHOLDER_TOKEN_ID="${DYN_IMAGE_PLACEHOLDER_TOKEN_ID:-151655}"
...
Environment variables:
  ...
  DYN_IMAGE_PLACEHOLDER_TOKEN_ID Token ID marking image span in token sequence
...
print_launch_banner --no-curl "CustomEncoder — Aggregated Serving" "$MODEL" "$HTTP_PORT" \
    ...
    "Placeholder: $IMAGE_PLACEHOLDER_TOKEN_ID" \
...
export DYN_IMAGE_PLACEHOLDER_TOKEN_ID="$IMAGE_PLACEHOLDER_TOKEN_ID"
